...
class TestAnchorbrowser:
    ...
    def test_hardcoded_query_params_in_url(self, client: Anchorbrowser) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: Anchorbrowser) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: Anchorbrowser) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
...
class TestAsyncAnchorbrowser:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncAnchorbrowser) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncAnchorbrowser) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
